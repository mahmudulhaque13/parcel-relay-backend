...
const createShipmentValidation = z.object({
  ...
  packageDescription: z.string().min(2, 'Package description must be at least 2 characters'),
...
const updateShipmentValidation = z.object({
  ...
  recipientPhone: z.string().min(7, 'Invalid recipient phone number').optional(),
...
const shipmentQueryValidation = z.object({
  ...
  sortBy: z.enum(['createdAt', 'updatedAt', 'deliveryCharge']).default('createdAt'),
